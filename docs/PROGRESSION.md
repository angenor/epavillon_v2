...
| API | ⬜ Rien de commencé — la constitution est posée (B0), le premier crate reste à écrire (B1) |
...
Le tableau et les obligations d'API relevées en écrivant les écrans : [`progression/api.md`](progression/api.md). **B0 est fait le 20/08** — la constitution est ratifiée ; aucun code Rust n'existe encore. Le prochain pas est **B1 — socle et identité**, `/speckit-specify`.
