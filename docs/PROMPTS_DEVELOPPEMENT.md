...
| B3 | **Événements** | Séries, éditions, journées, journées spéciales, salles(généralement les evenement se passent dans une seule salle mais on ne sait jamais), canal de diffusion, appel unique par édition, grille de critères, comité. Publication de la programmation avec contrôle préalable. |
