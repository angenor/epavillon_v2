...
const PATHS: Record<string, string> = {
  ...
  image: 'M4.8 4.5h14.4a.8.8 0 0 1 .8.8v13.4a.8.8 0 0 1-.8.8H4.8a.8.8 0 0 1-.8-.8V5.3a.8.8 0 0 1 .8-.8ZM4 16l4.6-4.6 3.4 3.4 2.4-2.4L20 18M15.5 9.5a1.2 1.2 0 1 0 0-.01',
