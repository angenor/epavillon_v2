 ...
 *   negotiation-access.ts  l'admission de Guide Négo : l'état d'accès, les
 *                        issues d'un code et la demande, hors ligne
 *   admin-negotiation.ts   le back-office de l'admission : codes, usages, file
 *                        des demandes et mode
