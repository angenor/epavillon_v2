...
export const reviewedProposals = [
  ...
  proposal({
    ...
    audience: { fr: "Directions du budget, points focaux genre, partenaires techniques et financiers." },
    format: 'hybrid',
  ...
  proposal({
    ...
    audience: { fr: "Collectivités, agences d'urbanisme, ONG de terrain, bailleurs." },
    format: 'in_person',
  ...
  proposal({
    ...
    audience: { fr: "Négociateurs, secrétariat de la CCNUCC, organisations d'appui aux délégations." },
    format: 'in_person',
  ...
  proposal({
    ...
    audience: { fr: "Services techniques municipaux, urbanistes, chercheurs." },
    format: 'hybrid',
  ...
  proposal({
    ...
    audience: { fr: "Assureurs, coopératives agricoles, ministères de l'agriculture, bailleurs." },
    format: 'in_person',
    category: 'results_sharing',
    country: COUNTRY.bf,
  ...
  proposal({
    ...
    audience: { fr: "Ministères de l'éducation, collectivités, ONG du secteur éducatif." },
    format: 'hybrid',
    category: 'field_project',
    country: COUNTRY.ht,
    duration: 90,
