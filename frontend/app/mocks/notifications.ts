...
const semer = (): Notification[] => [
  avis(
    ...
    {
      fr: 'Déplacée — Objectif mondial en matière d’adaptation, nouvelle heure 15:00 (heure de Belém), selon la source officielle.',
      en: 'Moved — Global goal on adaptation, new time 15:00 (Belém time), per the official source.',
    },
    { fr: 'Sessions de négociation', en: 'Negotiation sessions' },
  ...
  avis(
    ...
    {
      fr: 'Salle changée — Nouvel objectif collectif quantifié, nouvelle salle : Room Negro, signalé par le réseau et validé par l’IFDD.',
      en: 'Room changed — New collective quantified goal, new room: Room Negro, reported by the network and validated by IFDD.',
    },
    { fr: 'Sessions de négociation', en: 'Negotiation sessions' },
  ...
  avis(
    ...
    {
      fr: 'Non annoncée — Coordination francophone sur l’article 6.4, 10 novembre à 14:00, Pavillon de la Francophonie, signalé par le réseau et validé par l’IFDD.',
      en: 'Unannounced — Francophone coordination on Article 6.4, November 10 at 14:00, Francophonie Pavilion, reported by the network and validated by IFDD.',
    },
    { fr: 'Sessions de négociation', en: 'Negotiation sessions' },
  ...
  avis(
    ...
    {
      fr: 'Non retenu — Plénière d’ouverture du SBSTA : le changement était déjà connu.',
      en: 'Not retained — Opening plenary of the SBSTA: the change was already known.',
    },
    { fr: 'Sessions de négociation', en: 'Negotiation sessions' },
