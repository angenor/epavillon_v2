...
- Retouches du go (25/09) : **une coordination dont le groupe n'est pas reconnu s'importe quand même**, sans groupe — elle ne se voit que sous « Toutes », et se rattache dès que l'IFDD ajoute la dénomination au vocabulaire (une réunion perdue à l'import ne se rattrape pas, une étiquette manquante si) ; le jeu archivé versionné se réduit à ce que les tests exigent, le dépôt étant public.
...
- Un événement parallèle ou une conférence de presse : jamais importés.
...
- Une coordination dont le titre ne se rattache à aucun groupe connu (groupe manquant au vocabulaire, ou coordination d'observateurs) : importée sans groupe, visible sous « Toutes » seulement ; elle se rattache à la lecture qui suit l'ajout de sa dénomination.
...
- **FR-006** : Le filtre « Mes thématiques / Toutes » DOIT être offert ; « Mes thématiques » retient les sessions des thématiques que la personne suit les sessions sans thématique, marquées « Thématique non précisée », et les coordinations des groupes que la personne a cochés, portées « Mon groupe » — toutes les coordinations rattachées à un groupe quand elle n'en a coché aucun. Une coordination sans groupe reconnu ne se voit que sous « Toutes ». Un compteur dit le nombre de sessions affichées.
- **FR-006a** : Les groupes de négociation DOIVENT être un vocabulaire en base, semé des groupes réels ; la personne coche les siens sur l'écran « Mes thématiques », et ce choix suit le compte et passe par la file hors connexion. Une coordination se rattache à son groupe par les dénominations du terme, jamais par une liste du code ; le rattachement se refait à chaque lecture, si bien qu'une dénomination ajoutée rattache les coordinations déjà importées.
...
- **FR-012a** : L'import NE DOIT retenir que les réunions de négociation — négociations, plénières, événements mandatés, consultations de la présidence, réunions de coordination — et écarter les événements parallèles, conférences de presse et autres événements de la présidence. Une coordination dont le groupe n'est pas reconnu s'importe sans groupe. Le tri se fait par les données des vocabulaires, jamais par une liste du code.
