...
| 4 | **La plomberie hors connexion** | Magasin `ecritures`, intention portant empreinte et compte, départ à l'ouverture · `online` · retour au premier plan, vidange à la déconnexion, tests sans navigateur. **Et la lecture du vocabulaire à la première ouverture en ligne, avec le drapeau**, gardée comme lui | Elle conditionne le récit 1 hors connexion. Le vocabulaire est lu là parce qu'il relève de la coquille, pas d'un écran : la ligne du profil a ses noms même sur un appareil qui n'a jamais ouvert l'écran des thématiques |
